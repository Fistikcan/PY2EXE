...
options = [
    ...
    {"flag": "--add-data", "desc_tr": "Veri dosyası ekle (kaynak:hedef).", "desc_en": "Add data file (source:dest).", "type": "text", "placeholder": "veri.txt:."},
    {"flag": "--add-binary", "desc_tr": "Binary dosya ekle (kaynak:hedef).", "desc_en": "Add binary file (source:dest).", "type": "text", "placeholder": "lib.dll:."},
    {"flag": "--paths", "desc_tr": "Modül arama yolları (; ile ayır).", "desc_en": "Module search paths (; separated).", "type": "text", "placeholder": "C:\\eklentiler"},
    {"flag": "--hidden-import", "desc_tr": "Gizli modül ekle.", "desc_en": "Add hidden import.", "type": "text", "placeholder": "modül_adı"},
    {"flag": "--collect-submodules", "desc_tr": "Paketin tüm alt modüllerini topla.", "desc_en": "Collect all submodules.", "type": "text", "placeholder": "paket"},
    {"flag": "--collect-data", "desc_tr": "Paketin veri dosyalarını topla.", "desc_en": "Collect package data.", "type": "text", "placeholder": "paket"},
    {"flag": "--collect-binaries", "desc_tr": "Paketin binary’lerini topla.", "desc_en": "Collect package binaries.", "type": "text", "placeholder": "paket"},
    {"flag": "--collect-all", "desc_tr": "Paketin tüm kaynaklarını topla.", "desc_en": "Collect all package resources.", "type": "text", "placeholder": "paket"},
    {"flag": "--copy-metadata", "desc_tr": "Meta veriyi kopyala.", "desc_en": "Copy metadata.", "type": "text", "placeholder": "paket"},
    {"flag": "--recursive-copy-metadata", "desc_tr": "Meta veriyi alt paketlerle kopyala.", "desc_en": "Recursively copy metadata.", "type": "text", "placeholder": "paket"},
    {"flag": "--additional-hooks-dir", "desc_tr": "Ek hook dizini.", "desc_en": "Additional hooks directory.", "type": "path"},
    {"flag": "--runtime-hook", "desc_tr": "Çalışma zamanı hook dosyası.", "desc_en": "Runtime hook file.", "type": "path"},
    {"flag": "--exclude-module", "desc_tr": "Modülü hariç tut.", "desc_en": "Exclude module.", "type": "text", "placeholder": "modül"},
    ...
    {"flag": "--upx-exclude", "desc_tr": "UPX dışlanacak dosya.", "desc_en": "UPX exclude file.", "type": "text"},
...
<script>
    ...
    function buildOptionsUI() {{
        ...
        OPTIONS.forEach(opt => {{
            ...
            let inputField = null;
            if (['text', 'path', 'int', 'choice'].includes(opt.type)) {{
                inputField = document.createElement('input');
                inputField.className = 'option-input';
                inputField.placeholder = opt.placeholder || '';
                if (opt.type === 'int') inputField.type = 'number';
            ...
            if (opt.type === 'path') {{
                ...
                browse.addEventListener('click', async (e) => {{
                    ...
                    if (p && inputField) inputField.value = p;
                }});
                card.appendChild(browse);
            }}

            card.appendChild(info);
            if (inputField) card.appendChild(inputField);
    ...
    buildBtn.addEventListener('click', () => {{
        ...
        document.querySelectorAll('#optionsContainer input[type=checkbox]:checked').forEach(cb => {{
            ...
            const input = card.querySelector('input.option-input, select.option-input');
        ...
        terminalToggle.textContent = LANG[currentLang].show_terminal;
        backHomeBtn.style.display = 'none';
        buildStatusDiv.style.display = 'flex';
        showPage(3);
